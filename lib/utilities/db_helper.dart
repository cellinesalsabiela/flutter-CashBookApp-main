...
class DbHelper {
  ...
  static Future<void> insertDataUser(Database database) async {
    await database.execute("""
      ...
      ('Celline', 'celline', 'celline@gmail.com', 'secret123', 'assets/images/profil.jpg'),
      ('Celline Salsabiela', 'cellinesalsabiela', 'cellinesalsabiela@gmail.com', 'secret123', 'assets/images/profile.JPG')
    """);
  }
  ...
  // Get user login
  // mendapatkan informasi login pengguna dari database
